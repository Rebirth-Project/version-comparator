...
public class StrictSemanticVersionParserTest {

    private final StrictSemanticVersionParser parser = new StrictSemanticVersionParser();
    ...
    @CsvSource({
        ...
        "999999999999999999.9999999.9999999999999999",
        "1.0.0-0A.is.legal"
    })
